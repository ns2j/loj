...
public class P_Range implements Proxiable, XMergeable, XArrayFormulaRange, XCellFormatRangesSupplier, XUniqueCellFormatRangesSupplier, XCellRangeAddressable, XCellRangesQuery, XSubTotalCalculatable, XPropertySet, XUnoTunnel, XAutoFormattable, XSheetCellRange, XPropertyState, XCellRangeFormula, XIndent, XArrayFormulaTokens, XFormulaQuery, XWeak, XReplaceable, XSheetFilterableEx, XCellRangeData, XMultipleOperation, XModifyBroadcaster, XChartDataArray, XServiceInfo, XImportable, XMultiPropertySet, XSheetOperation, XTolerantMultiPropertySet, XSortable, XTypeProvider, XColumnRowRange, XCellSeries {
    protected Object proxy;

    public P_Range(Object object) {this.proxy = object;}

    public P_Range qi(Object object) {
    ...
    public P_Range prop(String key, Object value) throws IllegalArgumentException, UnknownPropertyException, PropertyVetoException, WrappedTargetException {
